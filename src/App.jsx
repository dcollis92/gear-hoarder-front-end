...
const App = () => {
  ...
  const updateRig = async (rigData) => {
    ...
    setRigs(rigs.map((rig) => (rig.id === updatedRig.id ? updatedRig : rig)));
  ...
  const updateAmp = async (ampData) => {
    ...
    setAmps(amps.map((amp) => (amp.id === updatedAmp.id ? updatedAmp : amp)));
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/rigs"
          element={<RigList rigs={rigs} rigImages={rigImages} />}
        />
        <Route
          path="/amps"
          element={<AmpList amps={amps} ampImages={ampImages} />}
        />
        <Route
          path="/guitars"
          element={<GuitarList guitars={guitars} guitarImages={guitarImages} />}
        />
        <Route
          path="/pedals"
          element={<PedalList pedals={pedals} pedalImages={pedalImages} />}
        />
        <Route
          path="/rigs/:id"
          element={<RigDetails rigImages={rigImages} user={user} />}
        />
        <Route
          path="/amps/:id"
          element={<AmpDetails ampImages={ampImages} user={user} />}
        />
        <Route
          path="/guitars/:id"
          element={<GuitarDetails guitarImages={guitarImages} user={user} />}
        />
        <Route
          path="/pedals/:id"
          element={<PedalDetails pedalImages={pedalImages} user={user} />}
        />
        <Route
          path="/rigs/new"
          element={
        ...
        <Route
          ...
          element={
            <ProtectedRoute user={user}>
              <AmpForm addAmp={addAmp} user={user} />
            </ProtectedRoute>
          }
        />
        <Route
          ...
          element={
            <ProtectedRoute user={user}>
              <GuitarForm addGuitar={addGuitar} user={user} />
            </ProtectedRoute>
          }
        />
        <Route
          ...
          element={
            <ProtectedRoute user={user}>
              <PedalForm addPedal={addPedal} user={user} />
            </ProtectedRoute>
          }
        />
        <Route
