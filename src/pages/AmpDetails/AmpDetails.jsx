      ...
      <>
        <section className="amp-details-container">
          ...
          <div className="amp-details">
            ...
            {amp.type !== "Cabinet" ? <p>Power: {amp.power_type}</p> : <p></p>}
            ...
            amp.type !== "Power" ? (
              <p>
                {amp.speaker_amount} x {amp.speaker_size} {amp.type}
              </p>
            ) : (
              <p></p>
            )}
            ...
            {amp.on_loan === false ? <p>On Loan: No</p> : <p>On Loan: Yes</p>}
            {amp.is_working === true ? <p>Working: Yes</p> : <p>Working: No</p>}
