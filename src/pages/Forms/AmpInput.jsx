const AmpInput = ({ form, handleChange }) => {
  return (
    <>
      ...
      <input
        value={form.make ? form.make : ''} onChange={handleChange} id="make" required name="make" type="text" placeholder="Marshall" autoComplete="off" />
      <label htmlFor="model">Model</label>
      <input
        value={form.model ? form.model : ''} onChange={handleChange} id="model" required name="model" type="text" placeholder="JCM 800" autoComplete="off" />
      <label htmlFor="wattage">Wattage</label>
      <input
        value={form.wattage ? form.wattage : ''} onChange={handleChange} id="wattage" required name="wattage" type="text" placeholder="100" autoComplete="off" />
      <label htmlFor="speakerSize">Speaker Size</label>
      <input
        value={form.speakerSize ? form.speakerSize : ''} onChange={handleChange} id="speakerSize"
        required name="speakerSize" type="text" placeholder="12" autoComplete="off" />
      ...
      <input
        ...
        required name="speakerAmount" type="text" placeholder="2" autoComplete="off" />
      ...
      <input
        ...
        required name="color" type="color"  autoComplete="off" />
      ...
      <input
        ...
        required name="description" type="text" placeholder="Original UK Production" autoComplete="off" />
