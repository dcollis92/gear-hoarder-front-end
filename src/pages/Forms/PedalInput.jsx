const PedalInput = ({ form, handleChange }) => {
  return (
    <>
      ...
      <input
        value={form.type ? form.type : ''} onChange={handleChange} id="type" required name="type" type="text" placeholder="Overdrive" autoComplete="off" />
      <label htmlFor="make">Make</label>
      <input
        value={form.make ? form.make : ''} onChange={handleChange} id="make" required name="make" type="text" placeholder="Ibanez" autoComplete="off" />
      <label htmlFor="model">Model</label>
      <input
        value={form.model ? form.model : ''} onChange={handleChange} id="model" required name="model" type="text" placeholder="TS9 Tube Screamer" autoComplete="off" />                
      ...
      <input
        ...
        required name="description" type="text" placeholder="First Generation, Made in Japan" autoComplete="off" />
