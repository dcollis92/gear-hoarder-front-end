    ...
    <>
      ...
      <Form.Group className="mb-3">
        ...
        <Form.Control value={form.make ? form.make : ''} 
          ...
          name="make" type="text" placeholder="Fender" 
          autoComplete="off" />
      </Form.Group>
      <Form.Group className="mb-3">
        ...
        <Form.Control value={form.model ? form.model : ''} 
          ...
          name="model" type="text" placeholder="Jazzmaster" 
          autoComplete="off" />
      </Form.Group>           
      <Form.Group className="mb-3">
      ...
      <Form.Control value={form.color ? form.color : ''} 
        ...
        name="color" type="text" placeholder="Sunburst"  
        autoComplete="off" />
      </Form.Group>
      <Form.Group className="mb-3">
      ...
      <Form.Control value={form.description ? form.description : ''} 
        ...
        name="description"  type="text" placeholder="Single Coil" autoComplete="off" />
      </Form.Group>
      <Form.Group className="mb-3">
