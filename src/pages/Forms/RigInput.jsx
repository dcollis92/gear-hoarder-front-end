  ...
  return (
    <>
      <Form.Group className="mb-3">
        ...
        <Form.Control value={form.name ? form.name : ''} 
        onChange={handleChange} id="name" required 
        name="name" type="text" placeholder="Black Sabbath rig" 
        autoComplete="off"  />
      </Form.Group>
        <Form.Group className="mb-3">
        ...
        <Form.Control value={form.description ? form.description : ''} 
          ...
          name="description"  type="text" placeholder="Used by Iommi from 1970-1973..." autoComplete="off" />
      </Form.Group>    
    </>
  )
}
